...
class QAutoencoder:
    ...
    def fit_data(self, batch_size=256, epochs=EPOCHS):
        ...
        self.path_to_model = f'model{mini}/{self.model_name_id}_{str(self.loss)[0:7]}loss/KERAS_check_best_model{mini}.model'
    ...
    def fit_data_Q_aware(self, batch_size=256, epochs=Q_EPOCHS):
        ...
        self.path_to_quantized_model = f'model{mini}/{self.model_name_id}_{str(self.loss)[0:7]}loss/QAE{self.BIT_WIDTH}bits/KERAS_check_best_model{mini}.model'
        ...
        callbacks = all_callbacks(stop_patience=1000,
                                  ...
                                  lr_cooldown=2,
                                  lr_minimum=0.0000001,
                                  outputDir=f'model{mini}/{self.model_name_id}_{str(self.loss)[0:7]}loss/QAE{self.BIT_WIDTH}bits/callbacks')
    ...
    def convert_to_tflite(self):
        ...
        path_to_tflite_model = f'model{mini}/{self.model_name_id}_{str(self.loss)[0:7]}loss/saved_objects{mini}'
